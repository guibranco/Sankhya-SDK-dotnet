...
public static class EntityValidation
{
    ...
    /// </summary>
    public static readonly Regex ReferenceFieldsFirstLevelPattern =
        new(
    ...
    /// </summary>
    public static readonly Regex ReferenceFieldsSecondLevelPattern =
        new(
    ...
    /// </summary>
    public static readonly Regex PropertyValueErrorPattern =
        new(
    ...
    /// </summary>
    public static readonly Regex PropertyNameErrorPattern =
        new(
    ...
    /// </summary>
    public static readonly Regex PropertyNameAssociationErrorPattern =
        new(
    ...
    /// </summary>
    public static readonly Regex PropertyNotFoundPattern =
        new(
    ...
    /// </summary>
    public static readonly Regex PropertyNameInvalidErrorPattern =
        new(
    ...
    /// </summary>
    public static readonly Regex PropertyWidthErrorPattern =
        new(
    ...
    /// </summary>
    public static readonly Regex PropertyForeignKeyRestrictionPattern =
        new(
    ...
    /// </summary>
    public static readonly Regex DuplicatedDocumentPattern =
        new(
    ...
    /// </summary>
    public static readonly Regex BusinessRuleRestrictionPattern =
        new(
    ...
    /// </summary>
    public static readonly Regex FullTransactionLogsPattern =
        new(
    ...
    /// </summary>
    public static readonly Regex MissingRelationPattern =
        new(
    ...
    /// </summary>
    public static readonly Regex MissingAttributePattern =
        new(
