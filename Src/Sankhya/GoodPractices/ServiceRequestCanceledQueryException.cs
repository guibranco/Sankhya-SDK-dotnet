...
public class ServiceRequestCanceledQueryException : ServiceRequestGeneralException
{
    ...
    public ServiceRequestCanceledQueryException(string message, ServiceRequest request, Exception innerException)
        : base(message, request, innerException)
    { }

    public ServiceRequestCanceledQueryException(string message, ServiceRequest request, ServiceResponse response)
        : base(message, request, response)
    { }

    public ServiceRequestCanceledQueryException(string message, ServiceRequest request, ServiceResponse response, Exception innerException)
